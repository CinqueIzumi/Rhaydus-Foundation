...
mavenPublishing {
    ...
    pom {
        name.set("core-common")
        description.set("Brand-agnostic, non-visual shared primitives (dispatchers, logging, result helpers, date/time/number formatting) shared across the nl.rhaydus apps.")
